...
/* ============================================================
   ...
   Alternatively pass { filters: [{ services: ['battery_service'] }] }
   to only show devices that advertise a specific service.
   ============================================================ */
btnScan.addEventListener('click', async () => {
  ...
  try {
    ...
    state.device = await navigator.bluetooth.requestDevice({
      acceptAllDevices: true,    // Show all nearby BLE devices
      optionalServices: [],      // Request optional service UUIDs if needed
    });
